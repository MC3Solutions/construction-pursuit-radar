...
function rec({id,title,due,url,type='NCDOT Letting',location='North Carolina',status='Advertised'}){
  return {source:'NCDOT',state:'NC',s:id,n:title,d:due,l:location,scope:'Highway / Bridge Construction',c:'237310',r:url,type:`NCDOT ${status} ${type}`,sourceLabel:'NCDOT',set:'State / Local',p:RUN,u:RUN,x:NC_CENTER[0],y:NC_CENTER[1],approx:true};
}
